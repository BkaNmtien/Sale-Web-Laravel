...
//Route account
Route::get('/account-profile', [UserController::class, 'myAccount'])->name('user.profile');
...
// Route login google
Route::get('/google-log-in', [UserController::class,'redirectToGoogle']);
Route::get('/auth/callback', [UserController::class,'handleGoogleCallback']);



// Note
// Quản lý banner: ảnh, mô tả, link, sx, vị trí đặt banner
// Phân quyền
