        ...
        <div class="container-fluid">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="{{route('home.index')}}"><img class="main__logo--img" src="{{url('asset-user')}}/img/logo/nav-log3.jpg" alt="logo-img"></a></h1>
                </div>
                ...
                <div class="header__account header__sticky--none d-none d-lg-flex ">
                    <nav class="header__menu--navigation ">
                        <ul class="d-flex">
                            <li class="header__account--items ">
                                @if(Auth::check())
                                <a class="header__account--btn " href="{{route('user.profile')}}">
