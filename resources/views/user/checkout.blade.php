        ...
        <div class="checkout__page--inner d-flex">
            <div class="main checkout__mian">
                <header class="main__header checkout__mian--header mb-30">
                    <h1 class="main__logo--title"><a class="logo logo__left mb-20" href="index.html"><img src="{{url('asset-user')}}/img/logo/nav-log3.jpg" alt="logo"></a></h1>
                ...
                <main class="main__content_wrapper">
                    @if(!Auth::check())
                        <div class="checkout__content--step section__contact--information">
                            <div class="section__header checkout__section--header d-flex align-items-center mb-25">
                                <h2 class="section__header--title text-danger mr-5 ">Bạn vui lòng đăng nhập để tiếp tục mua hàng!</h2>
                                <h2 class="layout__flex--item">
                                    <a class="layout__flex--item__link btn btn-primary btn-lg active " role="button" aria-pressed="true" href="{{route('user.index')}}?page=checkout.index">Đăng nhập</a>  
                                </h2>
                            </div>
                        </div>
                    @else
